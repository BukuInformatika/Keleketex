...
\section{Bahasa}
LateX punya kemampuan untuk dapat mengatur tulisan aturan ejaan yang dimiliki oleh beberapa bahasa tertentu.
Hal tersebut dapat diatur dengan menggunakan \textit{babel package} yang dimilki LateX tersebut dapat berpengaruh pada pemenggalan kata,spasi pada setiap kata, dan beberapa dokumen yang menggunakan heading.
contoh perintah yang mengatur LateX untuk menggunakan babel bahasa indonesia :
\lstinputlisting[caption=Perintah babel text,label={lst:bahasa}]{src/2/babel.tex}
