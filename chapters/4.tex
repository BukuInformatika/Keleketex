...
\lstinputlisting[caption=Memberikan Perintah Tabel,label={lst:Latihan tabel}]{src/1/tabel2.tex}

Dan maka hasil dari outputnya akan seperti dibawah ini :
...
\lstinputlisting[caption=Memberikan Perintah Tabel,label={lst:Latihan tabel}]{src/1/tabel3.tex}
