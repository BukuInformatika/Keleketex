...
\section{Format Font}
Terdapat beberapa jenis format font pada Latex yang dapat kita gunakan,
berikut ini adalah jenis jenis format font pada latex \ref{lst:ukuranfont}

\lstinputlisting[caption=contoh ukuran font,label={lst:ukuranfont}]{src/1/ukuranfont.tex}
